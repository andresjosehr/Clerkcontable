...
jQuery(document).ready(function() {
    ...
    */
    $('.page-title').backstretch("assets/img/backgrounds/3.png");
    $('.counters-container').backstretch("assets/img/backgrounds/3.png");
    $('.our-motto-container').backstretch("assets/img/backgrounds/3.png");
    $('.call-to-action-container').backstretch("assets/img/backgrounds/3.png");
