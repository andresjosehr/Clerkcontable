    ...
    <body>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 our-motto section-description wow fadeInLeftBig">
	                    <p> <br><br>
	                    	<h1>Servicios</h1>
	                    	<h4>Tenemos los mejores servicios de contabilidad del mercado, contactanos ahora</h4>
	                    </p> <br>
	        ...
	        <div class="container">
	            <div class="row">
	            	...
	            	<div class="col-sm-8 block-2-box block-2-right wow fadeInUp">
	            		<b style="font-size: 40px;">$ 1.500</b> Inicial <br>
	            		<b style="font-size: 40px;">$ 2.000</b> Mensual <br>
	            		<p><br>
	            			Iva <br>
	                    	IIBB <br>
	                    	Asesoría <br>
	                    	Liquidación para Sociedades <br>
	                    	Regimen Informativo <br>
	                    	DDJJ F931 Sueldos
	            		</p>
	            		<p>
	            		</p><br>
	            		...
	            		<div class="about-social">
		                	<a mp-mode="dftl" href="https://www.mercadopago.com/mla/checkout/start?pref_id=94021202-630baff0-8376-4863-9292-11c3dfc46f39" name="MP-payButton" class='blue-tr-l-ov-none'>Mercadopago</a>
        ...
        <div class="pricing-2-container section-container">
	        <div class="container">
	            ...
	            <div class="row">
	                <div class="col-sm-4 pricing-2-box wow fadeInUp">
	                    <div class="pricing-2-table">
	                    	<h3>Plan 1</h3>
	                    	<!-- <h4>Mesual</h4> -->
	                    	<div class="pricing-2-table-divider"><span></span></div>
	                    	<div class="pricing-2-table-price">$<span>200</span></div>
	                    	<div class="pricing-2-table-description">
	                    		<p><span>Asesoria</span>Mensual</p>
		                    		<!-- <p><span>Normal</span> speed</p>
		                    		<p><span>500</span> emails</p>
		                    		<p><span>300MB</span> storage</p> -->
							</div>
							<div class="pricing-2-table-button">
								<a class="big-link-1 btn" href="servicio_1.php">Ordenar Ahora</a>
							</div>
	                    </div>
	                </div>
	                <div class="col-sm-4 pricing-2-box wow fadeInDown">
	                    <div class="pricing-2-table">
	                    	<h3>Plan 2</h3>
	                    <!-- 	<h4>Best value</h4> -->
	                    	
	                    	<div class="pricing-2-table-price">$<span>300</span></div>
	                    	<div class="pricing-2-table-description">
	                    		<p><span>Liquidacion</span> IIBB</p>
	                    		<p><span>Monotributo</span></p>
	                    		<!-- <p><span>2000</span> emails</p>
	                    		<p><span>500MB</span> storage</p> -->
							</div>
							<div class="pricing-2-table-button">
								<a class="big-link-1 btn" href="servicio_2.php">Ordenar Ahora</a>
							</div>
	                    </div>
	                </div>
	                <div class="col-sm-4 pricing-2-box wow fadeInUp">
	                	<div class="pricing-2-table">
	                    	...
	                    	<div class="pricing-2-table-description">
	                    		<p><span>Liquidacion de</span> Monotributo</p>
	                    		<p><span>Asesoria</span></p>
	                    		<!-- <p><span>4000</span> emails</p>
	                    		<p><span>900MB</span> storage</p> -->
							</div>
							<div class="pricing-2-table-button">
								<a class="big-link-1 btn" href="servicio_3.php">Ordenar ahora</a>
							</div>
	                    </div>
	                </div>
	                <div class="col-sm-4 pricing-2-box wow fadeInDown">
	                	<div class="pricing-2-table">
	                    	...
	                    	<div class="pricing-2-table-divider"><span></span></div>
	                    	<div class="pricing-2-table-price">$<span>700</span> Inicial</div>
	                    	<div class="pricing-2-table-price">$<span>1.000</span> Mensual</div>

	                    	<div class="pricing-2-table-description">
	                    		<p><span>iibb</span></p>
	                    		<p><span>Liquidacion</span> iva</p>
	                    		<p><span>Regimen</span> Informativo</p>
	                    	<!-- 	<p><span>2GB</span> storage</p> -->
	                    	
							</div>
							<div class="pricing-2-table-button">
								<a class="big-link-1 btn" href="servicio_4.php">Ordenar ahora</a>
							</div>
	                    </div>
	                </div>
	                <div class="col-sm-4 pricing-2-box wow fadeInDown">
	                	<div class="pricing-2-table">
	                    	...
	                    	<!-- <h4>Bigger business</h4> -->
	                    	<div class="pricing-2-table-divider"><span></span></div>
	                    	<div class="pricing-2-table-price">$<span>1.500</span></div>
	                    	<div class="pricing-2-table-price">$<span>2.000</span> Mensual</div>
	                    	<div class="pricing-2-table-description">

	                    		<p><span>Iva</span></p>
	                    		<p><span>IIBB</span></p>
	                    		<p><span>Asesoría</span></p>
	                    		<p><span>Liquidación para</span> Sociedades</p>
	                    		<p><span>Regimen</span> Informativo</p>
	                    		<p><span>DDJJ F931</span> Sueldos</p>
	                    	<!-- 	<p><span>2GB</span> storage</p> -->
							</div>
							<div class="pricing-2-table-button">
								<a class="big-link-1 btn" href="servicio_5.php">Ordenar ahora</a>
							</div>
	                    </div>
	                </div>
	            </div>
